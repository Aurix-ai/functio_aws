...
def fallback_function_definition_finder(name:str, qualifier:Optional[str]=None):
    BIN="/home/ubuntu/ClickHouse_debug/build_debug/programs/clickhouse"
...
def function_lookup(function_name, file_path):
    ...
    if result:
        ...
        print(f"  Opening brace: {brace_open}")
        print(f"  Closing brace: {brace_close}")
        print(f"\nFunction signature and body:")
        print(source_code[start:brace_close+1])
        return file_path, result
    else:
        print(f"Function '{function_name}' () not found using traditional way. Trying alternative")
        alternative_file_path = fallback_function_definition_finder(function_name)
        ...
        if result:
            ...
            print(f"\nFunction signature and body:")
            print(source_code[start:brace_close+1])
            return alternative_file_path,result
        else:
            print(result)
