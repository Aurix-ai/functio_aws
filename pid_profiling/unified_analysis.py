...
def run_flamegraph(executable_command=None, pid=None, duration=10, output_base="flamegraph"):
    ...
    try:
        ...
        print(f"Error: FlameGraph generation timed out after 1800 seconds", file=sys.stderr)
        if stdout_output:
...
def analyze_flamegraph_strategy_5(folded_content, source_locations=None, output_base="flamegraph", full_paths=False, excluded_dirs=None, verbose=False, prefix_path=None, custom_prefix=None):
...
def unified_strategy(query , output_base, verbose, full_paths, exclude_dir, prefix_path=None, custom_prefix=None):
    ...
    try:
        ...
        if verbose:
            print("[*] Reading foldeextract_source_locationsd file for analysis...")
        ...
        if verbose:
            ...
            print("="*80)
        analysis = analyze_flamegraph_strategy_5(folded_content, source_locations, output_base, full_paths=full_paths, excluded_dirs=exclude_dir, verbose=verbose, prefix_path=prefix_path, custom_prefix=custom_prefix)
